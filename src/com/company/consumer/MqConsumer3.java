        ...
        public static void main(String[] args) throws Exception {
            ...
            Consumer consumer2 = new DefaultConsumer(channel1) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    ...
                    System.out.println(LocalDateTime.now()+" 【consumer3】 【RECEIVED】 message: " + message);
                    AsyncAck.handleMsg("consumer3",message,QpsConsumer.config.getRealExecuteTime());
                    AsyncAck.ack("consumer3",ackChanel,message,this,envelope.getDeliveryTag(),QpsConsumer.config.getRealAckTime());
                }
            };
            //注册配置消费者修改qps配置
